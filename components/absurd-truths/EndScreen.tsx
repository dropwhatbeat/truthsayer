  ...
  return (
    ...
    >
      ...
      <svg className="doodle" style={{ top: 30, left: 10, opacity: 0.2 }} width="44" height="44" viewBox="0 0 44 44" fill="none">
        <path d="M22 2 L26.5 15 L41 15 L30 23.5 L34 37 L22 28.5 L10 37 L14 23.5 L3 15 L17.5 15 Z" stroke="#d8401e" strokeWidth="2" strokeLinejoin="round"/>
      </svg>
      <svg className="doodle" style={{ top: 30, right: 10, opacity: 0.2 }} width="44" height="44" viewBox="0 0 44 44" fill="none">
        <path d="M22 2 L26.5 15 L41 15 L30 23.5 L34 37 L22 28.5 L10 37 L14 23.5 L3 15 L17.5 15 Z" stroke="#6a9a26" strokeWidth="2" strokeLinejoin="round"/>
      </svg>
      <span className="doodle font-caveat bottom-40 left-6 -rotate-[12deg]" style={{ fontSize: '1.5rem', color: '#d8401e', opacity: 0.15 }}>✦</span>
      <span className="doodle font-caveat bottom-52 right-8 rotate-[10deg]"  style={{ fontSize: '1.25rem', color: '#6a9a26', opacity: 0.18 }}>✦</span>
      <svg className="doodle" style={{ bottom: 100, left: 0, opacity: 0.15 }} width="120" height="18" viewBox="0 0 120 18" fill="none">
        <path d="M0 9 Q15 1 30 9 Q45 17 60 9 Q75 1 90 9 Q105 17 120 9" stroke="#6a9a26" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
      </svg>

      <div className="relative z-10 w-full max-w-sm flex flex-col items-center text-center">
        <div className="text-6xl mb-4">🏆</div>
        <h2 className="font-caveat font-bold" style={{ fontSize: '3.5rem', color: '#d8401e', lineHeight: 1.1 }}>
          Game Over.
        </h2>
        ...
        <button
          ...
          className="btn-press w-full font-caveat font-bold mb-4"
          style={{
            fontSize: '1.7rem',
            padding: '20px 24px',
            background: '#6a9a26',
            color: '#f4faea',
            border: '3px solid #4f7a1c',
            borderRadius: '8px 26px 6px 22px / 22px 6px 26px 8px',
            boxShadow: '5px 5px 0 #4f7a1c',
