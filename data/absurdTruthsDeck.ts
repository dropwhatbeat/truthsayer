...
export const GAME_DECK: Card[] = [
  {
    phrase: 'Groak',
    categories: [{ emoji: '🦑', label: 'sea creature' }, { emoji: '💃', label: 'old dance' }, { emoji: '🍳', label: 'kitchen tool' }],
  ...
  {
    phrase: 'Borborygmus',
    categories: [{ emoji: '🦕', label: 'dinosaur' }, { emoji: '🏛️', label: 'ancient philosopher' }, { emoji: '🔊', label: 'stomach sound' }],
  ...
  {
    phrase: 'Psithurism',
    categories: [{ emoji: '💆', label: 'ancient therapy' }, { emoji: '🍹', label: 'cocktail' }, { emoji: '🌿', label: 'sound of wind in trees' }],
  ...
  {
    phrase: 'Callipygian',
    categories: [{ emoji: '🏺', label: 'ancient vase' }, { emoji: '🏛️', label: 'type of column' }, { emoji: '🍑', label: 'well-shaped buttocks' }],
  ...
  {
    phrase: 'Mumpsimus',
    categories: [{ emoji: '🤼', label: 'wrestling move' }, { emoji: '☁️', label: 'type of cloud' }, { emoji: '🧠', label: 'stubbornly wrong belief' }],
  ...
  {
    phrase: 'Gobemouche',
    categories: [{ emoji: '🥐', label: 'French pastry' }, { emoji: '🐦', label: 'type of bird' }, { emoji: '😶', label: 'gullible person' }],
  ...
  {
    phrase: 'Petrichor',
    categories: [{ emoji: '🌸', label: 'perfume brand' }, { emoji: '💊', label: 'ancient remedy' }, { emoji: '🌧️', label: 'smell of rain on dry earth' }],
  ...
  {
    phrase: 'Zarf',
    categories: [{ emoji: '⚔️', label: 'medieval title' }, { emoji: '🥄', label: 'kitchen gadget' }, { emoji: '☕', label: 'coffee cup holder' }],
  ...
  {
    phrase: 'Gardyloo',
    categories: [{ emoji: '🌿', label: 'garden tool' }, { emoji: '🍸', label: 'cocktail' }, { emoji: '🪣', label: 'warning before throwing waste' }],
  ...
  {
    phrase: 'Apricity',
    categories: [{ emoji: '🍊', label: 'type of fruit' }, { emoji: '🧴', label: 'cleaning product' }, { emoji: '☀️', label: 'warmth of winter sun' }],
  ...
  {
    phrase: 'Hiraeth',
    categories: [{ emoji: '🍵', label: 'tea blend' }, { emoji: '🧦', label: 'Welsh clothing' }, { emoji: '🏔️', label: 'Welsh longing' }],
    answer: "Hiraeth is a Welsh word for a deep, aching longing for a home you can no longer return to — or perhaps one that never fully existed except in memory. It carries grief, love, nostalgia, and yearning simultaneously in a way no single English word manages. The Welsh consider it an essentially untranslatable national emotion and use it in ordinary conversation. English has borrowed it for poetry because English simply does not have an equivalent and, it turns out, needed one badly.",
  },
  {
    phrase: 'Limerence',
  ...
  {
    phrase: 'Collywobbles',
    categories: [{ emoji: '🐛', label: 'type of insect' }, { emoji: '💃', label: 'old dance' }, { emoji: '😰', label: 'stomach anxiety' }],
  ...
  {
    phrase: 'Vellichor',
    categories: [{ emoji: '🧵', label: 'type of fabric' }, { emoji: '💊', label: 'medical term' }, { emoji: '📚', label: 'wistfulness of used bookshops' }],
  ...
  {
    phrase: 'Xenoglossy',
    categories: [{ emoji: '📱', label: 'language app' }, { emoji: '🍞', label: 'type of bread' }, { emoji: '🔮', label: 'speaking an unknown language' }],
  ...
  {
    phrase: 'Sonder',
    categories: [{ emoji: '⛵', label: 'navigation tool' }, { emoji: '🍝', label: 'pasta shape' }, { emoji: '💭', label: 'realising strangers have full lives' }],
  ...
  {
    phrase: 'Phosphene',
    categories: [{ emoji: '⚗️', label: 'chemical element' }, { emoji: '🌱', label: 'type of plant' }, { emoji: '✨', label: 'light from pressing your eyes' }],
  ...
  {
    phrase: 'Frobly-Mobly',
    categories: [{ emoji: '🥞', label: 'breakfast food' }, { emoji: '💃', label: 'old dance' }, { emoji: '😐', label: 'neither well nor unwell' }],
    answer: "Frobly-mobly is an archaic English expression for the precise state of being neither well nor unwell — not sick enough to complain with any credibility, but not good enough to feel enthusiastic about anything. It appeared in British slang dictionaries in the early 1800s and then vanished completely. It is the verbal equivalent of the noncommittal shoulder shrug. English retained 'fine' as the standard evasion instead, which is a measurable downgrade in descriptive accuracy.",
  },
  {
    phrase: 'Snudge',
    categories: [{ emoji: '🛋️', label: 'type of cuddle' }, { emoji: '🪤', label: 'old trap' }, { emoji: '🎭', label: 'miser at home, generous in public' }],
  ...
  {
    phrase: 'Scripturient',
    categories: [{ emoji: '📎', label: 'office supply' }, { emoji: '📜', label: 'ancient script' }, { emoji: '✍️', label: 'uncontrollable urge to write' }],
  ...
  {
    phrase: 'Lollygag',
    categories: [{ emoji: '🍭', label: 'type of candy' }, { emoji: '🎣', label: 'fishing technique' }, { emoji: '🐌', label: 'wasting time aimlessly' }],
  ...
  {
    phrase: 'Bumfuzzle',
    categories: [{ emoji: '🍳', label: 'cooking technique' }, { emoji: '🐜', label: 'small creature' }, { emoji: '😵', label: 'to confuse completely' }],
  ...
  {
    phrase: 'Cattywampus',
    categories: [{ emoji: '🎮', label: "children's game" }, { emoji: '👒', label: 'hat style' }, { emoji: '↗️', label: 'askew and crooked' }],
  ...
  },
  {
    ...
    categories: [{ emoji: '🪞', label: 'mirror divination' }, { emoji: '🏋️', label: 'ancient Greek sport' }, { emoji: '🔮', label: 'fortune telling with mirrors' }],
  ...
  {
    phrase: 'Tyromancy',
    categories: [{ emoji: '🧀', label: 'cheese divination' }, { emoji: '🏊', label: 'ancient sport' }, { emoji: '✨', label: 'fortune telling with cheese' }],
  ...
  {
    phrase: 'Sternutation',
    categories: [{ emoji: '💃', label: 'ancient dance' }, { emoji: '🍝', label: 'type of pasta' }, { emoji: '🤧', label: 'the act of sneezing' }],
  ...
  {
    phrase: 'Ploiter',
    categories: [{ emoji: '🦑', label: 'sea creature' }, { emoji: '🔧', label: 'old tool' }, { emoji: '😴', label: 'working while barely working' }],
  ...
  },
  {
    ...
    categories: [{ emoji: '🏺', label: 'ancient ritual' }, { emoji: '☁️', label: 'type of cloud' }, { emoji: '💰', label: 'making money by any means' }],
  ...
  {
    phrase: 'Rawgabbit',
    categories: [{ emoji: '🐟', label: 'type of fish' }, { emoji: '💃', label: 'old dance' }, { emoji: '🤫', label: 'confidently gossiping about nothing' }],
  ...
  {
    phrase: 'Snoutfair',
    categories: [{ emoji: '🥐', label: 'type of pastry' }, { emoji: '🎲', label: 'old game' }, { emoji: '😍', label: 'an attractive person' }],
  ...
  },
  {
    ...
    categories: [{ emoji: '🦋', label: 'type of insect' }, { emoji: '🥐', label: 'pastry' }, { emoji: '🌀', label: 'a frivolous, flighty person' }],
  ...
  {
    phrase: 'Sempiternal',
    categories: [{ emoji: '🍝', label: 'pasta shape' }, { emoji: '🪦', label: 'funeral tradition' }, { emoji: '♾️', label: 'eternal and unchanging' }],
    answer: "Sempiternal means eternal and unchanging — but with a specific philosophical weight implying that the thing has always existed and will always continue to exist, without beginning, without end, and without variation. It comes from the Latin semper, always, and aeternus, eternal — making it more absolute than merely eternal. Theologians used it specifically to describe certain divine attributes. It entered English in the fifteenth century, left mainstream use, and has since been adopted almost exclusively by philosophers, theologians, and certain rock bands.",
  },
  {
    phrase: 'Meraki',
    categories: [{ emoji: '🍹', label: 'cocktail' }, { emoji: '🍝', label: 'pasta brand' }, { emoji: '✨', label: 'doing something with your whole soul' }],
    answer: "Meraki is a modern Greek word for the quality of doing something with your whole soul — putting a piece of yourself into what you make, approaching it with love and creativity rather than efficiency or obligation. It has no direct single-word translation in English, which is why English borrowed it eagerly in the 2010s when people found they needed a word for a quality they valued but could not name. Greeks are reportedly somewhat baffled by how urgently the rest of the world apparently needed this concept explained to them.",
  },
  {
    phrase: 'Sprezzatura',
    categories: [{ emoji: '🍝', label: 'Italian sauce' }, { emoji: '🏋️', label: 'Italian sport' }, { emoji: '✨', label: 'the art of effortless mastery' }],
  ...
  {
    phrase: 'Kummerspeck',
    categories: [{ emoji: '🐷', label: 'type of animal' }, { emoji: '🌲', label: 'German forest' }, { emoji: '🍫', label: 'weight gained from emotional eating' }],
  ...
  {
    phrase: 'Tsundoku',
    categories: [{ emoji: '🛋️', label: 'furniture style' }, { emoji: '🎮', label: 'old game' }, { emoji: '📚', label: 'buying books and not reading them' }],
  ...
  {
    phrase: 'Fernweh',
    categories: [{ emoji: '🌿', label: 'type of fern' }, { emoji: '📐', label: 'German measurement' }, { emoji: '✈️', label: 'ache for distant places' }],
